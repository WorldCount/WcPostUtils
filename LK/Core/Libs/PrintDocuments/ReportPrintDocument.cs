...
{
    public class ReportPrintDocument : TablePrintDocument
    {
        ...
        public ReportPrintDocument(DataGridView dataGridView, int[] columnWidths, bool clear = false)
        {
            _dataGridView = dataGridView;
            _columnWidths = columnWidths;
            _clear = clear;

            SetMargin(new Margins(30, 30, 40, 40));
        }
        ...
        private void PrintTableHeader(PrintPageEventArgs e, int topMargin)
        {
            ...
            while (colCount < _dataGridView.Columns.Count)
            {
                ...
                e.Graphics.DrawRectangle(Pens.Black, new Rectangle(colLeft, topMargin, colWidth, HeaderHeight));
                e.Graphics.DrawString(gridCol.HeaderText, PrintPens.BoldFont, PrintPens.ForeBrush, new Rectangle(colLeft, topMargin, colWidth, HeaderHeight), _stringFormat);
