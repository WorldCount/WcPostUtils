...
namespace LK.Forms.TarifForms
{
    ...
    {
        private List<FirstMailTarif> _tarifs;
        ...
        public FirstMailTarifForm()
        {
            ...
            Text = $"{Properties.Settings.Default.AppName}: Тарифы на письма 1 класса";
        ...
        {
            _tarifs = await FirstMailTarifManager.LoadAsync();
        ...
        private void dataGridView_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                FirstMailTarif tarif = GetModelByRowIndex<FirstMailTarif>(e.RowIndex);
        ...
        private void tbFilter_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                List<FirstMailTarif> filtered = _tarifs.Where(m => m.Name.ToUpper().Contains(q) || m.Rate.ToString("N2").Contains(q) || m.RateNds.ToString("N2").Contains(q) || m.Mass.ToString().Contains(q)).ToList();
        ...
        {
            _tarifs = await FirstMailTarifManager.GetFromServer();
            UpdateData();
        ...
        {
            FirstMailTarifManager.Save(_tarifs);
