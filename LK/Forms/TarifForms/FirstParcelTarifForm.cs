...
namespace LK.Forms.TarifForms
{
    ...
    {
        private List<FirstParcelTarif> _tarifs;
        ...
        public FirstParcelTarifForm()
        {
            ...
            Text = $"{Properties.Settings.Default.AppName}: Тарифы на бандероли 1 класса";
        ...
        {
            _tarifs = await FirstParcelTarifManager.LoadAsync();
        ...
        private void dataGridView_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                FirstParcelTarif tarif = GetModelByRowIndex<FirstParcelTarif>(e.RowIndex);
        ...
        private void tbFilter_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                List<FirstParcelTarif> filtered = _tarifs.Where(m => m.Name.ToUpper().Contains(q) || m.Rate.ToString("N2").Contains(q) || m.RateNds.ToString("N2").Contains(q) || m.Mass.ToString().Contains(q)).ToList();
        ...
        {
            _tarifs = await FirstParcelTarifManager.GetFromServer();
            UpdateData();
        ...
        {
            FirstParcelTarifManager.Save(_tarifs);
