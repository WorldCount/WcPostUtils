...
namespace LK.Forms.TarifForms
{
    ...
    {
        private List<ParcelTarif> _tarifs;
        ...
        {
            _tarifs = await ParcelTarifManager.LoadAsync();
        ...
        private void dataGridView_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                ParcelTarif tarif = GetModelByRowIndex<ParcelTarif>(e.RowIndex);
        ...
        private void ParcelTarifForm_Load(object sender, EventArgs e)
        {
            LoadData();
        }

        private void ParcelTarifForm_KeyDown(object sender, KeyEventArgs e)
        {
            // Нажатие Ctrl + S
        ...
        {
            _tarifs = await ParcelTarifManager.GetFromServer();
            UpdateData();
        ...
        {
            ParcelTarifManager.Save(_tarifs);
        ...
        private void tarificateMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                _tarifs = tarificatorForm.ParcelTarifs;
                UpdateData();
            }
        }
        ...
        private void tbFilter_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                List<ParcelTarif> filtered = _tarifs.Where(m => m.Rate.ToString("N2").Contains(q) || m.RateNds.ToString("N2").Contains(q) || m.Mass.ToString().Contains(q)).ToList();
